...
<div>
<h3><i>Этот проект представляет собой нейронную сеть для предсказания социально-демографических характеристик пользователей на основе данных, предоставленных RUTUB. Наша цель - создать точную и эффективную модель, которая поможет лучше понимать аудиторию и улучшать пользовательский опыт.</i></h3>
</div>
